...
(function () {
    ...
    var skills = [
        ...
        { name: "Liquid", pct: 82, icon: "M12 22a7 7 0 0 0 7-7c0-2-1-3.9-3-5.5s-3.5-4-4-6.5c-.5 2.5-2 4.9-4 6.5C6 11.1 5 13 5 15a7 7 0 0 0 7 7z" },
    ...
    function renderSkills() {
        ...
        skills.forEach(function (skill) {
            ...
            icon.innerHTML = '<svg viewBox="' + (skill.view || "0 0 24 24") + '" aria-hidden="true" focusable="false"><path fill="currentColor" d="' + skill.icon + '"/></svg>';
